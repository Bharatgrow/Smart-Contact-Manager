...
public class HomeController {
   ...
   private UserRepository userRepository;
    ...
    public String success(@Valid @ModelAttribute("user")User user,
    @RequestParam(value = "agreement",defaultValue = "false")boolean agreement,Model model,HttpSession session,BindingResult result1)
    {
       try {
